    ...
    <div className="about-section-container">
      ...
      <div className="about-section-text-container">
        <div
          ...
          style={{ marginTop: "150px", marginRight: "60px" }}
        >
          <div className="card" style={{ height: "400px", width: "250px" }}>
            ...
            <div className="card-body">
              <p className="card-text" style={{ fontSize: "1.2rem" }}>
                <b>Arunachalam</b>
                <br></br>Correspondent - National Engineering college
              </p>
            </div>
          </div>
          <div className="card" style={{ height: "400px", width: "250px" }}>
            ...
            <div className="card-body">
              <p className="card-text" style={{ fontSize: "1.2rem" }}>
                <b>Kalidasa Murugavel</b>
                <br></br>Principal - National Engineering college
              </p>
            </div>
          </div>
          <div className="card" style={{ height: "400px", width: "250px" }}>
            ...
            <div className="card-body">
              <p className="card-text" style={{ fontSize: "1.2rem" }}>
                <b>Shanmugavel</b>
                <br></br>Director - National Engineering college
              </p>
            </div>
          </div>
        </div>
