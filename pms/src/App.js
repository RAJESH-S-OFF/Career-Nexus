...
import UpcomingCompanies from "./components/Admin/Company-CRUD/UpcomingCompanies.js";
import AddUpcomingCompany from "./components/Admin/Company-CRUD/AddUpcomingCompany.js";
import UpdateUpcomingCompany from "./components/Admin/Company-CRUD/UpdateUpcomingCompany.js";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/add-upcoming-company" element={<AddUpcomingCompany />} />
        <Route path="/update-upcoming-company/:id" element={<UpdateUpcomingCompany />}
        />
        {/* <Route path="/upcomingcompanylisting" element={}/> */}
